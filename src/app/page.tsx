...
export default function Home() {
  return (
    <main className="flex flex-col items-center min-h-screen">
      ...
      <StorefrontSection />
      <NewsletterSection />
      <footer className="w-full py-12 md:py-16 bg-background text-foreground border-t border-border mt-auto">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
            {/* Column 1: Brand/Logo */}
            <div className="flex flex-col items-center sm:items-start">
              <Link href="/" className="flex flex-col items-center sm:items-start group mb-4">
                <Gem size={28} className="mb-1 text-accent group-hover:text-accent/80 transition-colors" />
                <span className="font-headline text-3xl tracking-wider text-accent uppercase group-hover:text-accent/80 transition-colors">
                  Pala
                </span>
              </Link>
            ...
            <div className="text-center sm:text-left">
              <h3 className="font-headline text-lg font-semibold text-foreground mb-4">Liens Rapides</h3>
              <ul className="space-y-2">
                <li><Link href="/accueil" className="text-sm text-muted-foreground hover:text-accent">Accueil</Link></li>
                <li><Link href="/shop" className="text-sm text-muted-foreground hover:text-accent">Shop</Link></li>
                <li><Link href="/produits" className="text-sm text-muted-foreground hover:text-accent">Produits</Link></li>
            ...
            <div className="text-center sm:text-left">
              <h3 className="font-headline text-lg font-semibold text-foreground mb-4">Suivez-Nous</h3>
              ...
              <div className="mt-6">
                <h3 className="font-headline text-lg font-semibold text-foreground mb-2">Contactez-Nous</h3>
                <p className="text-sm text-muted-foreground">contact@palajewelry.com</p>
                <p className="text-sm text-muted-foreground">+261 38 22 224 84</p>
              </div>
            </div>

            {/* Column 4: Newsletter Reminder */}
            <div className="text-center sm:text-left">
              <h3 className="font-headline text-lg font-semibold text-foreground mb-4">Restons Connectés</h3>
              <p className="text-sm text-muted-foreground mb-3">
                Abonnez-vous à notre newsletter pour découvrir nos dernières collections et offres exclusives.
              </p>
              <Button variant="outline" asChild className="w-full sm:w-auto border-input hover:bg-accent hover:text-accent-foreground">
