...
import { Search, ShoppingBag, User, Menu, ChevronDown, Home, Store, Calendar, Facebook, Instagram, Twitter, Info } from 'lucide-react';
...
const Header = ({ themeVariant = 'default', country, exchangeRate }: HeaderProps) => {
  ...
  return (
    ...
    >
      <nav
        className={cn(
          "container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between font-kanit",
          isScrolled ? 'text-foreground' : textClass
        )}
      >
