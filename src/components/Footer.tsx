        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex space-x-4 justify-center sm:justify-start">
              <Link href="#" aria-label="Facebook" className="text-foreground/80 hover:text-primary"><Facebook size={24} /></Link>
              <Link href="#" aria-label="Instagram" className="text-foreground/80 hover:text-primary"><Instagram size={24} /></Link>
              <Link href="#" aria-label="Twitter" className="text-foreground/80 hover:text-primary"><Twitter size={24} /></Link>
            </div>
            <div className="mt-6">
              <h3 className="font-headline text-lg font-semibold text-foreground mb-2">Contactez-Nous</h3>
              <p className="text-sm text-foreground/80">contact@palajewelry.com</p>
              <p className="text-sm text-foreground/80">+261 38 22 224 84</p>
            </div>
          </div>
